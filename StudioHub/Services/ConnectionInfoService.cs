...
public static class ConnectionInfoService {
    ...
    public static string ConnectionString => $"{_baseConnectionString};Initial Catalog=";

    public static string GetPrimaryConnectionString() {
        return ConnectionString + PrimaryDB;
    }

    public static string GetLegacyConnectionString() {
        return ConnectionString + LegacyDB;
    }
    ...
    public static void Initialize() {
        ...
        _baseConnectionString = builder.ConnectionString.TrimEnd(';');
    ...
    private static void mappingEntities() {
        ...
        */
        FluentMapper.Entity<MailMergeTemplateData>()
            .Table("Core.MailMergeTemplateData")
            .Primary(x => x.Id);
        FluentMapper.Entity<MailMergeTemplateInfo>()
            .Table("Core.MailMergeTemplateInfo")
            .Primary(x => x.Id)
            .Identity(x => x.Id);
    }
